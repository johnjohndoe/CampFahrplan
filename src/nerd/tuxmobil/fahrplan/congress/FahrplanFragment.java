...
public class FahrplanFragment extends SherlockFragment implements OnClickListener, OnNavigationListener, OnParseCompleteListener {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		trackColors.put("Web Development", R.drawable.event_border_default_web_development);
		trackColors.put("System Administration", R.drawable.event_border_default_ccc);
		trackColors.put("Development", R.drawable.event_border_default_other);
		trackColors.put("Security", R.drawable.event_border_default_ethics_society_politics);
		trackColors.put("Monitoring", R.drawable.event_border_default_hardware_making);
		trackColors.put("Culture", R.drawable.event_border_default_science_engineering);
		trackColors.put("Virtualisierung", R.drawable.event_border_default_virtualization);
		trackColors.put("Other", R.drawable.event_border_default_entertainment);
		trackColors.put("", R.drawable.event_border_default_entertainment);
		trackColors.put("Database", R.drawable.event_border_default_hardware_making);
		trackColors.put("Javascript", R.drawable.event_border_default_art_beauty);
		trackColors.put("Hardware", R.drawable.event_border_default_security_safety);
		trackColors.put("PHP Devroom", R.drawable.event_border_default_entertainment);
		trackColors.put("RedFrogConf (Ruby)", R.drawable.event_border_default);
		trackColors.put("Java", R.drawable.event_border_default_entertainment);
		trackColors.put("Systems Management", R.drawable.event_border_default_development);
		trackColors.put("Python Devroom", R.drawable.event_border_default_entertainment);
		trackColors.put("LISP Devroom", R.drawable.event_border_default_entertainment);

		trackColorsHi = new HashMap<String, Integer>();
		trackColorsHi.put("Web Development", R.drawable.event_border_highlight_web_development);
		trackColorsHi.put("System Administration", R.drawable.event_border_highlight_ccc);
		trackColorsHi.put("Development", R.drawable.event_border_highlight_other);
		trackColorsHi.put("Security", R.drawable.event_border_highlight_ethics_society_politics);
		trackColorsHi.put("Monitoring", R.drawable.event_border_highlight_hardware_making);
		trackColorsHi.put("Culture", R.drawable.event_border_highlight_science_engineering);
		trackColorsHi.put("Virtualisierung", R.drawable.event_border_highlight_virtualization);
		trackColorsHi.put("Other", R.drawable.event_border_highlight_entertainment);
		trackColorsHi.put("", R.drawable.event_border_highlight_entertainment);
		trackColorsHi.put("Database", R.drawable.event_border_highlight_hardware_making);
		trackColorsHi.put("Javascript", R.drawable.event_border_highlight_art_beauty);
		trackColorsHi.put("Hardware", R.drawable.event_border_highlight_security_safety);
		trackColorsHi.put("PHP Devroom", R.drawable.event_border_highlight_entertainment);
		trackColorsHi.put("RedFrogConf (Ruby)", R.drawable.event_border_highlight);
		trackColorsHi.put("Java", R.drawable.event_border_highlight_entertainment);
		trackColorsHi.put("Systems Management", R.drawable.event_border_highlight_development);
		trackColorsHi.put("Python Devroom", R.drawable.event_border_highlight_entertainment);
		trackColorsHi.put("LISP Devroom", R.drawable.event_border_highlight_entertainment);
