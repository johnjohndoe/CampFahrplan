...
android {
    ...
    productFlavors {
        ...
        create("fediday2026") {
            dimension = defaultDimension
            applicationId = "info.metadude.android.fediday.schedule"
            versionName = "${defaultConfig.versionName}-FediDay-Edition"
            buildConfigField("String", "GOOGLE_PLAY_URL", """"https://play.google.com/store/apps/details?id=info.metadude.android.fediday.schedule"""")
            buildConfigField("String", "F_DROID_URL", """"https://f-droid.org/packages/info.metadude.android.fediday.schedule"""")
            buildConfigField("String", "SCHEDULE_URL", """"https://ctalx.c-base.org/fediday-2026/schedule/export/schedule.xml"""")
            buildConfigField("String", "SCHEDULE_FILE_FORMAT", """"schedule_v1_xml"""")
            buildConfigField("String", "EVENT_URL", """"https://ctalx.c-base.org/fediday-2026/talk/%s/"""")
            buildConfigField("String", "EVENT_WEBSITE_URL", """"https://berlinfedi.day"""")
            buildConfigField("String", "EVENT_POSTAL_ADDRESS", """"Rungestraße 20, 10179 Berlin"""")
            buildConfigField("String", "SERVER_BACKEND_TYPE", """"pretalx"""")
            buildConfigField("boolean", "ENABLE_CHAOSFLIX_EXPORT", "true")
            buildConfigField("boolean", "ENABLE_ENGELSYSTEM_SHIFTS", "true")
            resValue("string", "preference_hint_engelsystem_json_export_url", """"https://engelsystem.anoxinon.de/shifts-json-export?key=YOUR_KEY"""")
